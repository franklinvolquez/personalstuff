package fr.kapit.lab.demo.model
{
	...
	/**
	 * Wrapper around the current layout instance of the visualizer component.
	 * This is done to dispatch what's going on, on the source code side, as
	 * log messages.
	 */
	public class LayoutModel implements ILayoutModel, IDisposable
	{
		/**
		 * Logger instance.
		 */
		 ...
		 * 		Current layout instance
		 */
		public function LayoutModel(targetName:String, layoutType:String, layout:Object)
		{
		...
		/**
		 * Returns the current layout, such as
		 * <code>HierarchicalLayout.ID</code>, <code>RadialLayout.ID</code>, ...
		 */		
		 ...
		 */
		public function set layerDistance(value:int):void
		{
			...
			_logger.info("{0}.layout.{1} = {2};", targetName, "layerDistance", value);
			_layout.layerDistance = value;
		}
		 ...
		 * <code>HierarchicalLayout</code>
		 */
		public function set defaultNodeDistance(value:int):void
		{
			if (! isLayoutTypeIn([ HierarchicalLayout.ID ]))
			{
			...
			_logger.info("{0}.layout.{1} = {2};", targetName, "defaultNodeDistance", value);
			_layout.defaultNodeDistance = value;
		}
		 ...
		 */
		public function set edgeDrawing(value:uint):void
		{
			...
			_logger.info("{0}.layout.{1} = {2};", targetName, "edgeDrawing", DebugUtil.edgeDrawTypeToString(value));
			_layout.edgeDrawing = value;
		}
		 ...
		 */
		public function set verticalDistance(value:int):void
		{
			...
			_logger.info("{0}.layout.{1} = {2};", targetName, "verticalDistance", value);
			_layout.verticalDistance = value;
		}
		 ...
		 * <code>SugiyamaLayout</code>
		 */
		public function set horizontalDistance(value:int):void
		{
			if (! isLayoutTypeIn([ SugiyamaLayout.ID ]))
			{
			...
			_logger.info("{0}.layout.{1} = {2};", targetName, "horizontalDistance", value);
			_layout.horizontalDistance = value;
		}
		 ...
		 */
		public function set nodesSpacing(value:int):void
		{
			...
			_logger.info("{0}.layout.{1} = {2};", targetName, "nodesSpacing", value);
			_layout.nodesSpacing = value;
		}
		 ...
		 */
		public function set usePseudoOrthogonalEdges(value:Boolean):void
		{
			...
			_logger.info("{0}.layout.{1} = {2};", targetName, "usePseudoOrthogonalEdges", value);
			_layout.usePseudoOrthogonalEdges = value;
		}
		 ...
		 */
		public function set angularSector(value:int):void
		{
			...
			_logger.info("{0}.layout.{1} = {2};", targetName, "angularSector", value);
			_layout.angularSector = value;
		}
		 ...
		 */
		public function set rootSelectionPolicy(value:int):void
		{
			...
			_logger.info("{0}.layout.{1} = {2};", targetName, "rootSelectionPolicy", DebugUtil.rootSelectionTypeToString(value));
			_layout.rootSelectionPolicy = value;
		}
		 ...
		 */
		public function set rootAngularSector(value:int):void
		{
			...
			_logger.info("{0}.layout.{1} = {2};", targetName, "rootAngularSector", value);
			_layout.rootAngularSector = value;
		}
		 ...
		 * <code>BalloonLayout</code>
		 */
		public function set childAngularSector(value:int):void
		{
			if (! isLayoutTypeIn([ BalloonLayout.ID ]))
			{
			...
			_logger.info("{0}.layout.{1} = {2};", targetName, "childAngularSector", value);
			_layout.childAngularSector = value;
		}
		 ...
		 * <code>BalloonLayout</code>
		 */
		public function set useEvenAngles(value:Boolean):void
		{
			if (! isLayoutTypeIn([ BalloonLayout.ID ]))
			{
			...
			_logger.info("{0}.layout.{1} = {2};", targetName, "useEvenAngles", value);
			_layout.useEvenAngles = value;
		}
		 ...
		 */
		public function set angle2(value:int):void
		{
			...
			_logger.info("{0}.layout.{1} = {2};", targetName, "angle2", value);
			_layout.angle2 = value;
		}
